...
# Name
`ngx_http_proxy_auth_netstorage_module` is an Nginx module that automatically generates [Akamai NetStorage](https://www.akamai.com/resources/product-brief/netstorage) authentication headers for proxy requests to Akamai NetStorage. It implements the [Akamai NetStorage Usage Api](https://techdocs.akamai.com/netstorage-usage/reference/format-an-api-call) for secure proxy access.

# Table of Content

- [ngx\_http\_proxy\_auth\_netstorage\_module](#ngx_http_proxy_auth_netstorage_module)
- [Name](#name)
...
- [Directives](#directives)
    - [`proxy_auth_netstorage`](#proxy_auth_netstorage)
    - [`proxy_auth_netstorage_account`](#proxy_auth_netstorage_account)
    - [`proxy_auth_netstorage_key`](#proxy_auth_netstorage_key)
    - [`proxy_auth_netstorage_uri`](#proxy_auth_netstorage_uri)
    - [`proxy_auth_netstorage_bypass`](#proxy_auth_netstorage_bypass)
- [Variables](#variables)
    - [`$proxy_auth_netstorage_action`](#proxy_auth_netstorage_action)
    - [`$proxy_auth_netstorage_data`](#proxy_auth_netstorage_data)
    - [`$proxy_auth_netstorage_sign`](#proxy_auth_netstorage_sign)
